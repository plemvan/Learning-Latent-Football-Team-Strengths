...
class NeuralBradleyTerry(nn.Module):
    ...
    def get_season_ranking(self, df_full, target_season, feature_cols):
        """
    ...
    def predict_season_probas(self, df_full, target_season, feature_cols, draw_threshold=0.5, home_advantage=0.3):
        """
